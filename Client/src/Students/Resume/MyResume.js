...
const Star = ({ starId, marked }) => {
  return (
    <span
      star-id={starId}
      role="button"
      style={{ color: "#ff9933", cursor: "pointer", fontSize: "2rem" }}
    >
      {marked ? "\u2605" : "\u2606"}
    </span>
  );
...
const MyResume = () => {
  ...
  const rohit = useSelector((reducer) => reducer);
  // console.log(rohit)
 ...
 currentcompany: {
    ...
    Describr_Your_Job_Profile:"",
    Notice_Period:'',
    Key_Skills:'',
    IT_Skills:'',
    Version:'',
    IT_Experience_inYears:'',
    IT_Experience_inMonths:'',
    Project_Title:'',
    Project_Client:'',
    Project_Type: {
      Project_Started_Working_From:' ',
      Project_Worked_Till:' ',
      },
    ...
    Marital_Status:'',
    Passport_Number:'',
    Work_Parmit_To_Other_Countries:'',
    Highest_Graduation:'',
    Course:'',
    Specialization:'',
    University:'',
...
const radiohandling = (e) => {
  ...
  const fresherHandling = (e) => {
    setReducer({ ...reducer, experience: e.target.value });
  };
  ...
  const patentpendingButton = () => {
    setPatent(false);
  };


  // const formHandling = (e) => {
  //   setReducer({ ...reducer, [e.target.name]: e.target.value });
  // //  console.log(reducer.Description)
  // };
                  ...
                  <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                      ...
                      <div className="modal-body ">
                        ...
                        <div className="modal-footer">
                          <button type="button" className="update" onClick={(e)=>handleUpdate(e)}>
                            Save changes
                          </button>
                        </div>
                      </div>
                  ...
                  <div className="modal-dialog modal-lg" role="document">
                    <div className="modal-content">
                      ...
                      <div className="modal-body ">
                                ...
                                <form>
                                  <div className="form-group">
                                    ...
                                    >
                                      ...
                                      <option value="phd" name="Highest_Graduation" onChange={(e)=>formHandling(e)} >PHD</option>
                                      <option value="postgraduation" name="Highest_Graduation" onChange={(e)=>formHandling(e)} >
                                        Masters / Postgraduation
                                      </option>
                                      <option value="undergraduation" name="Highest_Graduation" onChange={(e)=>formHandling(e)} >
                                        Undergraduation / Diploma
                                      </option>
                                      <option value="inter" name="Highest_Graduation" onChange={(e)=>formHandling(e)} >
                                        Intermediate
                                      </option>
                                    </select>
                                  </div>
                        ...
                        <div className="modal-footer">
                          <button type="button" className="update" onClick={()=>saveChanges()}>
                            Save changes
                          </button>
                        </div>
                      </div>
